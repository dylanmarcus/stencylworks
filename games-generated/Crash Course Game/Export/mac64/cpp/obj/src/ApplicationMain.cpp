...
Void ApplicationMain_obj::main( ){
{
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",30);
			{
				HX_STACK_LINE(32)
		...
		HX_STACK_LINE(30)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)800,(int)600,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("Caches"),null(),null());
	}
return null();
}
