...
{
HX_STACK_PUSH("AssetLibrary::new","openfl/Assets.hx",695);
{
}
;
	return null();
...
{
		HX_STACK_PUSH("AssetLibrary::loadSound","openfl/Assets.hx",786);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
...
{
		HX_STACK_PUSH("AssetLibrary::loadMovieClip","openfl/Assets.hx",779);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(779)
...
{
		HX_STACK_PUSH("AssetLibrary::loadFont","openfl/Assets.hx",772);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(772)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBytes","openfl/Assets.hx",765);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(765)
...
{
		HX_STACK_PUSH("AssetLibrary::loadBitmapData","openfl/Assets.hx",758);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(758)
...
{
		HX_STACK_PUSH("AssetLibrary::load","openfl/Assets.hx",751);
		HX_STACK_THIS(this);
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(751)
...
::flash::media::Sound AssetLibrary_obj::getSound( ::String id){
	HX_STACK_PUSH("AssetLibrary::getSound","openfl/Assets.hx",744);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(744)
	return null();
...
::String AssetLibrary_obj::getPath( ::String id){
	HX_STACK_PUSH("AssetLibrary::getPath","openfl/Assets.hx",737);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(737)
	return null();
...
::flash::display::MovieClip AssetLibrary_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("AssetLibrary::getMovieClip","openfl/Assets.hx",730);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(730)
	return null();
...
::flash::text::Font AssetLibrary_obj::getFont( ::String id){
	HX_STACK_PUSH("AssetLibrary::getFont","openfl/Assets.hx",723);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(723)
	return null();
...
::flash::utils::ByteArray AssetLibrary_obj::getBytes( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBytes","openfl/Assets.hx",716);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(716)
	return null();
...
::flash::display::BitmapData AssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("AssetLibrary::getBitmapData","openfl/Assets.hx",709);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(709)
	return null();
...
bool AssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("AssetLibrary::exists","openfl/Assets.hx",702);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
