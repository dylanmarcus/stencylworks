...
class HXCPP_CLASS_ATTRIBUTES  Scene_obj : public hx::Object{
	...
	public:
		...
		virtual ::haxe::ds::IntMap readRawLayers( ::flash::utils::ByteArray bytes,int numLayers);
		Dynamic readRawLayers_dyn();

		virtual ::haxe::ds::IntMap readLayers( Dynamic list,::haxe::ds::IntMap rawLayers);
