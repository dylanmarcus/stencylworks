...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("None"),HX_CSTRING("cache"),HX_CSTRING("com.stencyl.test"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_2","ApplicationMain.hx",30);
			{
				HX_STACK_LINE(32)
		...
		HX_STACK_LINE(30)
		::flash::Lib_obj::create( Dynamic(new _Function_1_2()),(int)0,(int)0,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int(::flash::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("Caches"),null(),null());
	}
return null();
}
...
{
		HX_STACK_PUSH("ApplicationMain::applyScale","ApplicationMain.hx",118);
		HX_STACK_ARG(_,"_");
		HX_STACK_LINE(120)
